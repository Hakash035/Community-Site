    ...
    <div className='footer'>
        ...
        <div className='sec-cont'>
            ...
            <div className="find-us">
                ...
                <FaInstagram size={40} style={{cursor:"pointer"}} onClick={()=>{window.open("https://www.instagram.com/c2c_club_svce/","blank")}}/>
                <a href='mailto:c2cofficial008@gamil.com' style={{color:"white"}}><FiMail size={40} style={{cursor:"pointer"}}/></a>
            </div>
        </div>
